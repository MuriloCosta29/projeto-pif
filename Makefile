SRC = src/barreira.c src/dados.c src/fisica.c src/game.c src/goleiro.c src/input.c src/main.c src/placar.c src/render.c src/medidor.c src/gol.c src/desenho.c src/torcida.c
